...
const ResumeDetailListCloseBtn = styled.button`
  ...
  right: 15px;
`;
function ResumeEduDraggableList({ index, testData, render, setRender }) {
  const [startYear, setStartYear] = useState("");
  const [startMonth, setStartMonth] = useState("");
  const [endYear, setEndYear] = useState();
  const [endMonth, setEndMonth] = useState();
  const [currentlyTrueFalse, setCurrentlyTrueFalse] = useState(false);
  const [oder, setOrder] = useState(testData.orderSchool);
  ...
  useEffect(() => {
    console.log(testData.idSchool, mainText, subText, currentlyTrueFalse, startYear, startMonth, endYear, endMonth);
    const timer = setTimeout(() => {
      resumeApi
        .changeSchoolList(testData.idSchool, mainText, subText, currentlyTrueFalse, startYear, startMonth, endYear, endMonth, detail,oder)
        .then((Response) => {
  ...
  }, [startYear, startMonth, endYear, endMonth, currentlyTrueFalse, mainText, subText, detail,oder]);

  return (
    <Draggable key={`${testData?.idSchool}`} draggableId={`${testData?.idSchool}`} index={index}>
      {(provided) => (
              ...
              <div>
                <div>
                    ...
                    <div>
                      <div>
                        <input
                          ...
                          defaultValue={testData.yearAdmission}
                          onInput={(e) => {
                        ...
                        <span>
                          ...
                          <input
                            ...
                            defaultValue={testData.monthAdmission}
                            onInput={(e) => {
                              e.target.value = e.target.value.replace(/[^0-9.]/g, "").replace(/(\..*)\./g, "$1");
                            }}
                            onChange={(e) => {
                    ...
                    <div>
                      ...
                      <div>
                        <input
                          ...
                          maxLength={4}
                          className="resume-detail-year"
                          defaultValue={testData.yearGraduate}
                          onInput={(e) => {
                            e.target.value = e.target.value.replace(/[^0-9.]/g, "").replace(/(\..*)\./g, "$1");
                          }}
                          onChange={(e) => {
                        ...
                        <span>
                          ...
                          <input
                            ...
                            maxLength={2}
                            className="resume-detail-month"
                            defaultValue={testData.monthGraduate}
                            onInput={(e) => {
                              e.target.value = e.target.value.replace(/[^0-9.]/g, "").replace(/(\..*)\./g, "$1");
                            }}
                            onChange={(e) => {
                  ...
                  <PeriodFromCheckBox>
                    <input
                      type={"checkbox"}
                      checked={currentlyTrueFalse}
                      onChange={(e) => {
                        setCurrentlyTrueFalse(e.target.value);
                      }}
                    />
              ...
              <div>
                <div>
                  <form action=".">
                    <SearchModalButton
                      type="text"
                      defaultValue={testData.schoolName}
                      placeholder={"학교명"}
                      onChange={(e) => {
...
export default ResumeEduDraggableList;
